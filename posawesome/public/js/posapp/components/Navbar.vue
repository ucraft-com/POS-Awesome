<template>
    <nav>
      ...
      <v-btn @click="openDatePicker" text color="primary">
  ...
  export default {
    ...
    primary_action({selected_date}) {
      evntBus.$emit('dateSelected', selected_date);
        d.hide();
      }
    });
    d.show();
    ...
    created: function () {
      this.$nextTick(function () {
        ...
        evntBus.$on('dateSelected', (date) => {
            ...
            this.selectedDate = frappe.datetime.obj_to_str(datetime)
