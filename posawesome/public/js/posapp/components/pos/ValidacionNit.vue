<template>
  <v-row justify="center">
    <v-dialog v-model="customerDialog" max-width="600px">
      <v-card>
        <v-card-title>
          <span class="headline indigo--text">{{ __('Validacion Nit') }}</span>
        </v-card-title>
            ...
            <v-row>
              <v-col cols="12">
                <v-text-field
                  dense
                  color="indigo"
                  :label="frappe._('Ingrese el numero de Nit')"
              ...
              <div v-if="visible_encontro_cliente">
              <v-col cols="6">
                <v-text-field
                  dense
                  color="indigo"
                  :label="frappe._('Nombre de Cliente:')"
                  background-color="white"
                  hide-details
