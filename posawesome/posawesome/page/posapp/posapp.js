...
frappe.pages['posapp'].on_page_load = function (wrapper) {
	...
	$("head").append("<link rel='stylesheet' href='/assets/posawesome/css/materialdesignicons.min.css' />");
	$("head").append("<link rel='stylesheet' href='/assets/posawesome/css/roboto.css' />");
};
